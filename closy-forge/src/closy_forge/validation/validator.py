...
def validate_package(package_dir: Path) -> dict[str, Any]:
    ...
    if manifest.get("garmentClass") == "simple_trousers" or str(
        ...
        from closy_forge.validation.simple_trousers_validator import (
    ...
    if manifest.get("garmentClass") == "simple_dress" or str(
        ...
        from closy_forge.validation.simple_dress_validator import (
    ...
    if manifest.get("garmentClass") == "jacket_outerwear" or str(
        ...
        from closy_forge.validation.jacket_outerwear_validator import (
